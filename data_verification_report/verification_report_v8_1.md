# v8.1 검증 보고서 [26.09.26 재확인]

> 이 검증 보고서를 남기는 이유는
> 검증 역추적 방식에 대한 기본 논리가 이 보고서에 잘 드러나기 때문이며,
> 이 보고서에서의 기본 논리가 구현될 시 향후 누군가 특정 RDF 트리플을 클릭했을 때,
...
v8 RDF와 CSV에 담긴 각 사실을 다시 출처까지 역추적하여 다음 구조를 확립하고자 했다.

> **개체/사건 → 주장(Claim) → 관계(Relation) → 날짜(Date) → 실제 출처(Source URL)**

기존 CSV의 `출처(1차 확인)` 컬럼은 "어떤 자료를 참고했는가" 수준에 머물러 있었고,
...
**기존 `1907-12-24 확정`을 그대로 유지할 근거를 찾지 못했다.**
...
`1907-12-24`를 다시 살리려면 **그 날짜를 직접 명시하는 별도의 공식/1차 자료 URL을 추가로 확보해야 한다.**

### 이 사례를 중요하게 보는 이유

이 사례는 필자가 왜 v8에서 Source Mapping을 도입해야 한다고 판단했는지를 그대로 보여준다.
...
아래 표에서 상태는 다음과 같이 구분했다.

* **확인** = 현재 실제 URL과 해당 사실의 직접적인 근거를 필자가 확인함
* **부분확인** = URL은 확인했지만 CSV의 모든 세부 주장까지 직접 뒷받침하지는 못함
* **재확인** = 기존 CSV에는 출처가 있으나 이번 검증에서 해당 URL의 직접 근거까지는 확정하지 못함
* **보류** = 관계 또는 날짜 자체가 논쟁적이어서 URL을 붙이는 것만으로 본인이 확정하지 않기로 함

> (여담> 온톨로지 전문가도 아닌 필자가 확정적으로 말할 수 있는 영역은 매우 적음.)
...
|  3 | 숭실학교     | 기존 CSV의 한국민족문화대백과사전 URL은 별도로 재확인해야 함                                                                                                                                                                                                                                                             | 재확인                |
|  4 | 보성학교     | 기존 CSV의 한국민족문화대백과사전 URL은 별도로 재확인해야 함                                                                                                                                                                                                                                                             | 재확인                |
...
|  9 | 북로군정서    | [한국민족문화대백과사전 — 북로군정서](https://encykorea.aks.ac.kr/Article/E0024657?utm_source=chatgpt.com)                                                                                                                                                                                                            | 확인 / 역할관계는 필자가 재검증  |
...
| 11 | 조선물산장려회  | [한국민족문화대백과사전 — 조선물산장려회](https://encykorea.aks.ac.kr/Article/E0052021?utm_source=chatgpt.com)                                                                                                                                                                                                          | **기존 8/23 확정, 필자가 재검토** |
| 12 | 신간회      | 기존 CSV의 한국민족문화대백과사전 URL을 직접 재확인해야 함                                                                                                                                                                                                                                                             | 재확인                |
| 13 | 보성사      | [한국민족문화대백과사전 — 보성사](https://encykorea.aks.ac.kr/Article/E0023417?utm_source=chatgpt.com)                                                                                                                                                                                                              | 확인                 |

### 11번 조선물산장려회도 수정이 필요하다고 판단했다
...
그러나 현재 한국민족문화대백과사전을 다시 확인해보니, 평양 조선물산장려회가 **1920년 8월 조만식·오윤선·김동원·김보애 등 70인이 발기·조직**했다고 서술되어 있었다. 정확한 `8월 23일`은 내가 확인한 해당 공식 URL에서는 직접 확인되지 않았다.

따라서 `1920-08-23 확정` 역시 **별도 날짜 근거가 확보될 때까지 Month 수준으로 낮추는 것이 안전하다**고 판단했다.
...
| 17 | 봉오동전투  | [한국민족문화대백과사전 — 봉오동전투](https://encykorea.aks.ac.kr/Article/E0023974?utm_source=chatgpt.com)    | 사건 자체는 직접 검색해서 확인        |
| 18 | 청산리전투  | 기존 CSV의 한국민족문화대백과사전 URL도 직접 재확인해야 함                                                       | 사건 자체는 확인, URL은 재확인 필요 |
| 19 | 물산장려운동 | [한국민족문화대백과사전 — 조선물산장려운동](https://encykorea.aks.ac.kr/Article/E0052020?utm_source=chatgpt.com) | 확인                    |

### 15번 안악사건

확인한 현재 공식 자료는 매우 명확했다.
...
| 23 | 유영모 | [한국민족문화대백과사전 — 유영모](https://encykorea.aks.ac.kr/Article/E0041674?utm_source=chatgpt.com)                                                                                                                                                                                            | **사사관계는 필자가 추가 검증**       |
| 24 | 함석헌 | 기존 CSV의 위키백과 URL을 다시 직접 재확인해야 함                                                                                                                                                                                                                                                        | 재확인                      |
...
| 28 | 배위량 | 기존 위키백과 URL을 다시 직접 재확인해야 함                                                                                                                                                                                                                                                            | 재확인                      |
| 29 | 최광옥 | 신민회 공식 명단: [한국민족문화대백과사전 — 신민회](https://encykorea.aks.ac.kr/Article/E0032974?utm_source=chatgpt.com)                                                                                                                                                                                 | 소속 확인                    |
| 30 | 차이석 | 기존 한국민족문화대백과사전 URL을 다시 직접 재확인해야 함                                                                                                                                                                                                                                                     | 재확인                      |
| 31 | 이용익 | 기존 한국민족문화대백과사전 URL을 다시 직접 재확인해야 함                                                                                                                                                                                                                                                     | 재확인                      |
...
| 36 | 이동녕 | 기존 한국민족문화대백과사전 URL을 다시 직접 재확인해야 함                                                                                                                                                                                                                                                     | 재확인                      |
| 37 | 이상룡 | 기존 한국민족문화대백과사전 URL을 다시 직접 재확인해야 함                                                                                                                                                                                                                                                     | 재확인                      |
| 38 | 지청천 | 기존 위키백과 URL을 다시 직접 재확인해야 함                                                                                                                                                                                                                                                            | 재확인                      |
...
| 42 | 김좌진 | [한국민족문화대백과사전 — 북로군정서](https://encykorea.aks.ac.kr/Article/E0024657?utm_source=chatgpt.com)                                                                                                                                                                                          | **신민회 관계는 보류로 판단**    |
| 43 | 서일  | [한국민족문화대백과사전 — 북로군정서](https://encykorea.aks.ac.kr/Article/E0024657?utm_source=chatgpt.com)                                                                                                                                                                                          | 조직관계 확인 / 공동설립은 내가 재검증   |
| 44 | 이범석 | 기존 위키백과 URL을 필자가 직접 재확인해야 함                                                                                                                                                                                                                                                            | 재확인                      |
...
| 49 | 박희도 | 기존 친일인명사전/위키백과 URL을 다시 직접 재확인해야 함                                                                                                                                                                                                                                                     | 재확인                      |

---

# 6. 검증 과정에서 확인한 주요 팩트 수정사항
...
**v9에서 12월 24일을 되살리려면 해당 날짜를 직접 명시하는 1차 또는 정부·공식 DB를 추가로 확보해야 한다.**
...
다만 **"1912년에 신흥무관학교로 공식 개칭"이라는 표현은 스스로 확정하지 않기로 했다.**

한국민족문화대백과사전 신민회 항목은 처음에는 신흥강습소로 불렀다가 뒤에 신흥무관학교로 이름을 바꾸었다고 설명하는 반면, 이시영 항목은 "신흥무관학교로 확대 발전"이라고 표현하고 있어서 서로 뉘앙스가 달랐다.

그래서 v9에서 **명칭관계의 존재 여부와 시점 불확실성을 분리해서 기록**하기로 했다.

---

## 수정사항 4 — 이동휘

필자가 확인한 공식 자료끼리도 표현 차이가 있었다.
...
v8부터 RDF의 모든 중요한 사실을 다음 구조로 추적하기로 했다.
...
A와 B가 모두 확인됐다고 해서 C가 자동으로 확정되는 것은 아니라고 필자는 판단내렸다.
...
는 **별도의 provenance 판단으로 따로 기록해야 한다고 결론지었다.**

이것이 필자가 v7에서 확립한 **"사건 날짜 자동상속 금지"** 원칙을 Source Mapping까지 확장한 것이다.

---

# 10. Provenance 상태값

필자는 각 Claim에 다음 상태를 부여하기로 했다.
...
# 12. v8 최종 Source Mapping 판정

이번 재검색 과정을 통해 필자는 **49개 전체를 단순히 "URL 있음 = 완료"로 처리하는 것은 부적절하다는 결론에 도달했다.**
...
### B. URL은 존재하지만 CSV의 세부 주장까지 직접 검증하지 못한 항목
...
이 항목들은 **`재확인`으로 남겨두는 것이 정직한 상태라고 판단했다.**
>  (참고> A의 URL은 진짜, B의 URL을 가짜라고 접근하여 AI에게 판단을 맡기려 했는데,
>  자연어를 기반으로 판정을 내리게 하는 건 무리가 있다고 판단했다.)
---

# 13. v8 추가보고서 최종 결론

v8의 RDF 자체는 앞서 진행한 rdflib 검증에서 구조적 무결성을 확인했다.

이번 Source Mapping 검증에서 확인한 다음 단계의 문제는 **문법 문제가 아니라 provenance 문제였다.**
...
이 기존 CSV의 "확정"보다 현재 공식 자료가 더 보수적인 값을 제시하고 있음을 확인했다. 

>오산학교는 공식 자료 간에 1907년 12월과 11월 24일이 서로 충돌하며, 
>조선물산장려회는 현재 공식 백과사전에서 1920년 8월까지만 직접 확인된다.

> 따라서 **v8을 완성본이라고 선언하기 전에 이 두 날짜를 포함한 provenance 충돌 항목을 CSV에 반영하는 것이 바람직하다**고 결론지었다.

> 최종적으로는 v9 이후의 RDF/CSV가 다음 수준을 목표로 해야 한다고 본다.
...
이것이 필자가 v8에서 구축하고자 한 **provenance layer의 최종 형태**다.

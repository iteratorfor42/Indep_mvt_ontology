...
- subject 엔티티가 원본 인물 매핑과 다르다는 사실은 `change_history`[최종 명칭: verification_report_v1-v10]에 기록
...
Claim 문장을 "이회영 등이 신흥강습소를 설립하였다"로 바꿔 구조화된 방향에 맞췄다. 공동설립자 전원을 주어에 넣으면 다중 주체 문제가 생길 수 있으므로 "등"으로 대표 표기했다. 
